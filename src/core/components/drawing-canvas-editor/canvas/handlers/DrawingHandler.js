...
class DrawingHandler {
  ...
  line = {
    ...
    addPoint: opt => {
      ...
      this.handler.activeLine.set({class: 'line'});
      this.handler.pointArray.push(circle);
  ...
  directionalLine = {
    ...
    addPoint: opt => {
      ...
      this.handler.activeLine.set({class: 'directionalLine'});
      this.handler.pointArray.push(circle);
      this.handler.canvas.add(this.handler.activeLine);
      this.handler.canvas.add(circle);
    },
    ...
    swap: opt => {
      opt.target.rotate(opt.target.angle + 180);
      this.handler.eventHandler.rotated(opt);
    }
  };
