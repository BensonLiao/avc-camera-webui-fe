...
class Canvas extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (JSON.stringify(this.props.formValues) !== JSON.stringify(prevProps.formValues)) {
      this.handler.setFormValuesOption(this.props.formValues);
    }
