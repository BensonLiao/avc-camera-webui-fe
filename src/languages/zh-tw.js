if (!window.languageResource['zh-tw']) {
  window.languageResource['zh-tw'] = {
    ...
    'validation-stringMin': '必須輸入{expected}個以上的字元',
    'validation-stringMax': '必須輸入{expected}個以下的字元',
    'validation-stringLength': '必須輸入{expected}個字元',
    ...
    Word: '文字',
    Position: '位置',
    'Select Position': '請在預覽窗格點選文字貼圖位置',
    'Text Overlay': '內容',
